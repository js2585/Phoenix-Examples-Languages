...
public class Robot extends TimedRobot {
    /** Hardware */
	TalonSRX hoodMotor = new TalonSRX(12);
	...
	public void robotInit() {
		...
		hoodMotor.configPeakOutputForward(Constants.kGains.kPeakOutput, Constants.kTimeoutMs);
		hoodMotor.configPeakOutputReverse(-Constants.kGains.kPeakOutput, Constants.kTimeoutMs);
		...
		hoodMotor.config_kF(Constants.kPIDLoopIdx, Constants.kGains.kF, Constants.kTimeoutMs);
//		hoodMotor.config_kP(Constants.kPIDLoopIdx, Constants.kGains.kP, Constants.kTimeoutMs);
		hoodMotor.config_kP(Constants.kPIDLoopIdx, joystickP, Constants.kTimeoutMs);
		hoodMotor.config_kI(Constants.kPIDLoopIdx, Constants.kGains.kI, Constants.kTimeoutMs);
		hoodMotor.config_kD(Constants.kPIDLoopIdx, Constants.kGains.kD, Constants.kTimeoutMs);
...
//
//		_sb.append("\tpos:");
//		_sb.append(hoodMotor.getSelectedSensorPosition(0));
//		_sb.append("u"); 	// Native units
		...
		if (button5) {
			...
			targetPositionRotations = leftZDegrees * 4096 / 360;
		...
		SmartDashboard.putNumber("Joystick Z Axis", _joy.getRawAxis(2));
		SmartDashboard.putNumber("Joystick Setpoint (Degrees)", _joy.getRawAxis(2) * 4096f / 360);
		SmartDashboard.putNumber("Current Position (Degrees)", hoodMotor.getSelectedSensorPosition() * 360f / 4096);
		SmartDashboard.putNumber("Closed Loop Error", hoodMotor.getClosedLoopError() * 360f / 4096);
